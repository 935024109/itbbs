     ...
     <div class="forum-left cl" style="padding: 0; border-radius: 2px; box-shadow: 0px 1px 1px rgba(0,0,0,0.08); overflow: hidden; background: #FFFFFF;"> 
      ...
      <div id="threadlist" class="tl bm bmw"> 
       ...
       <div class="bm_c"> 
        ...
        <div style="width: 100%;height: 1700px;border: 2px solid red;">
        <ul>
          <div style="height: 50px;border: 2px solid black;"></div>
        @foreach ($post as $k=>$v)
          <li  style="height: 100px;margin-top: 20px;border: 2px solid blue;">
            ...
            <div style="width: 1px;height: 100%;border: 2px solid black;float: left;margin-left: 40px;"></div>
            <div style="float: right;border: 2px solid yellow;height: 48px;width: 650px; ">
              <b><a href=""></a>{{$v->title}}</b>
            </div>
            <div style="float: right;border: 2px solid green;height: 48px;width: 650px;">
              <div>
