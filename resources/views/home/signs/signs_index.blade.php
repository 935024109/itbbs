...
1．签到时间：{{$data->sign_time}}<br>
2．要求签到信息的思想内容健康、积极向上。</div></div>
<div class="sd">
<div class="login-info bm">
<div class="user-info"><img class="avatar" src="/uploads/{{$user->photo}}" style="margin-top:-208px;width:150px;"><p class="m">本月已签到：{{$data->sign_count}}天</p><p class="m">已获得积分：{{$user->score}}</p></div>
</div>
<div class="bm bw0">
<div class="sign_div">
<div class="date-week">
